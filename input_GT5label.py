...
RGBgroundtruth={'dynamic','ground','road','sidewalk','parking','rail track',\
...
# 目的 处理一对图片的数据。按照其标签，将每一对图片的地址放入不同的文件中or做成
# 数据放在 /home/yangshuhui/code/GT5data/labelsplit 文件夹下面 
